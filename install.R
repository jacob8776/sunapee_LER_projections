...
remotes::install_github("aemon-j/gotmtools", ref = 'yaml') # if you have trouble installing LakeEnsmblR, try ref = 'yaml' here
remotes::install_github("aemon-j/SimstratR", ref = "v2.4")
