...
taylor.diagram(wideform$Obs,wideform$Simstrat,  main = "Surface Temperature", ref.sd = TRUE, col = 1)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Bottom Temperature", ref.sd = TRUE)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Schmidt Stability", ref.sd = TRUE)
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Total Stratification Duration", ref.sd = TRUE)
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Total Ice Duration", ref.sd = TRUE)
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Total Mixing Period", ref.sd = TRUE)
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
