...
Below are some example plots of the remaining thermal metric anomalies. After discussions during the meeting, the most important metrics highlighted in the discussion will be chosen based on how comprehensive and important ecologially they are. Current thoughts about these metrics is to include ice off, ice on, bottom temperature maximum and minimum, surface temperature maximum and minimum, total ice duration, and total stratification duration. 
