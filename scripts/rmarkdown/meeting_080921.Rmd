...
ggplot(anomalies_by_year, aes(x = year, y = var_model, col = "model")) + geom_point(size = 0.2)+
  geom_point(data = anomalies_by_year, aes(x = year, y = var_rcp, col = "rcp"), size = 0.2) +
...
Suggestions on choosing variables? 

Based on interesting and unique variance? Most important ecologically? 
