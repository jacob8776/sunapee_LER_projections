...
anomalies_master_bot <- read.csv(file.path(lake_directory, "anomaly_calculations/bot_anomalies_summer.csv"))
anomalies_master_sur <- read.csv(file.path(lake_directory, "anomaly_calculations/surf_anomalies_summer.csv"))
...
#anomalies_master_sur <- filter(anomalies_master_sur, month)
...
ggsave(paste0(lake_directory, '/figures/figure5_summer.png'), dpi = 300,width = 384,height = 280, units = 'mm')
