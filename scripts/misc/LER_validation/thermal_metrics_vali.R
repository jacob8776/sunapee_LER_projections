...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/schmidt_vali_wideform.csv", row.names = FALSE)
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/thermodepth_vali_wideform.csv", row.names = FALSE)
