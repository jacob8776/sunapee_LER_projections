...
anomalies_master_bot <- read.csv(file.path("./anomaly_calculations/bot_anomalies_summer.csv"))
anomalies_master_sur <- read.csv(file.path("./anomaly_calculations/surf_anomalies_summer.csv"))
...
ggsave('./figures/figure6_summer.png', dpi = 300,width = 384,height = 280, units = 'mm')