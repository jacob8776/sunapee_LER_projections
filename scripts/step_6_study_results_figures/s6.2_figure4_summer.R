...
# 
png("../../figures/figure4_summer.png", width = 5,height = 7, units = 'in', res = 200)
par(mfrow=c(3,2))
...
taylor.diagram(wideform$Obs,wideform$Simstrat,  main = "A) Surface Temperature", ref.sd = TRUE, col = 1, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
...
taylor.diagram(wideform$Obs, wideform$GOTM, main = "B) Bottom Temperature", ref.sd = TRUE, col = 5, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 2)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 4)
