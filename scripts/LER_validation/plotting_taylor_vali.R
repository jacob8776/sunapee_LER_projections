...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Summer Bottom Temperature", ref.sd = TRUE, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Schmidt Stability", ref.sd = TRUE, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Summer Thermocline Depth", ref.sd = TRUE, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Summer Stratification Duration", ref.sd = TRUE, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
...
taylor.diagram(wideform$Obs, wideform$Simstrat, main = "Ice Off", ref.sd = TRUE, xlab = "Standard Deviation (Obs)", ylab = "Standard Deviation (Model)")
taylor.diagram(wideform$Obs, wideform$GLM, add = TRUE, col = 3)
taylor.diagram(wideform$Obs, wideform$FLake, add = TRUE, col = 5)
taylor.diagram(wideform$Obs, wideform$MyLake, add = TRUE, col = 7)
taylor.diagram(wideform$Obs, wideform$GOTM, add = TRUE, col = 9)
