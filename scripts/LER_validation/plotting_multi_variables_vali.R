...
ncdf <- "~/Dropbox/sunapee_LER_projections/LER_validation/output/ensemble_output.nc"
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/tsmean_vali_wideform.csv", row.names = FALSE)
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/tbmean_vali_wideform.csv", row.names = FALSE)
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/totstratdur_vali_wideform.csv", row.names = FALSE)
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/mixper_vali_wideform.csv", row.names = FALSE)
