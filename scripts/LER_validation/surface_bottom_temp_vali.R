...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/surface_1m_wideform_vali.csv", row.names = FALSE)
...
write.csv(wideform ,"~/Dropbox/sunapee_LER_projections/LER_validation/vali_calcs/bottom_33m_wideform_vali.csv", row.names = FALSE)
